        ...
        >
          ...
          >
            <div className="p-4 md:p-6">
              <div className="flex justify-between items-start mb-4" onClick={() => setIsModalOpen(false)}>
              ...
              <ul className="list-disc list-inside">
                {desc.map((point, index) => (
                  <li 
                    key={index} 
                    className="text-sm md:text-base text-gray-300 mb-2 whitespace-pre-line"
                  >
                    {point}
                  </li>
                ))}
